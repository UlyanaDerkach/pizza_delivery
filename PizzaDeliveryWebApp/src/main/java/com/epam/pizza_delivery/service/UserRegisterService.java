...
public class UserRegisterService implements Service {
    ...
    private boolean confirmPassword(String password, String confirmPassword){ return password.equals(confirmPassword); }

    private void setUserParam(User newUser, HttpServletRequest request){
